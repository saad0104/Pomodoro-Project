...
public class CSPomotoBreak implements ActionListener {

    JFrame ptbFrame = new JFrame();
    JPanel ptbPanel = new JPanel();
    JLabel ptbLabel = new JLabel();
    JButton ptbBButton = new JButton("Take a Break");
    JButton ptbHButton = new JButton("HOME");

    CSPomotoBreak() {

        ptbLabel.setBounds(100, 20, 500, 300);
        ptbLabel.setText("<html> Just Finished a Session <BR> Lets a take a Break </html>");
